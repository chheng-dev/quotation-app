import { Action, Permission, PermissionCheck, Resource, User, UserProfile, FlatPermission } from "@/src/types/rbac";
...
export function getUserPermissions(user: User | null | undefined) {
  ...
  console.log('🔄 getUserPermissions - Transformed:', result);
  return result;
}
