...
export async function superadmin() {
  ...
  const createdPerms = await db.insert(permissions).values(perms).onConflictDoNothing().returning();
  ...
  const [adminUser] = await db
    ...
    .values({
      ...
      email: 'dex@gmail.com',
      code: 'SUPERADMIN001',
      passwordHash: '$2b$10$CwTycUXWue0Thq9StjUM0uJ8D6Pz3hXhN3kq6j0O5f6z1Z5K1G6eW', // bcrypt hash for 'dex12345'
      passwordConfirmation: '$2b$10$CwTycUXWue0Thq9StjUM0uJ8D6Pz3hXhN3kq6j0O5f6z1Z5K1G6eW',
      isActive: true,
      isVerified: true,
