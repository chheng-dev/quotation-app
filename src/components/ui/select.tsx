...
function Select({
  ...
  // Only provide value or defaultValue, never both
  const rootProps = {
    'data-slot': 'select',
    ...props,
...
function SelectItem({
  ...
  if (value === '') {
    return (
      <div
        data-slot="select-item-empty"
        className={cn(
          'text-muted-foreground flex w-full items-center justify-center py-2 text-sm select-none',
          className,
        )}
      >
        No data
